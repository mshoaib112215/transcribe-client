...
const MappedTimestampInput = ({ handleFileChange, timestampsFile, setTimeStamps, timeStamps, transcription, searches, data, setData, setIsCaputed, isCaputed }) => {
    ...
    useEffect(() => {
        ...
        try {
            let filteredSearches = searches.filter(search => search.result !== undefined || search.result !== "" || search.result !== null);
    ...
    return (
        <div className="w-full mt-12">
            ...
            <div className="w-full mt-4">
                ...
                <div className="w-[100%] h-[50vh] mt-4">
                    <DataTable
                        columns={columns}
                        data={data}
                        responsive
...
export default MappedTimestampInput