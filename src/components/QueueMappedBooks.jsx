        ...
        <>
            ...
            <div className="container m-auto p-3">
                ...
                <div className='flex justify-center flex-wrap  whitespace-nowrap gap-3'>
                    ...
                    <Link to='/mapped-books' className='border bg-white  shadow-md flex-1 p-12 flex justify-center rounded-lg cursor-pointer'>
                        <div className='flex items-center gap-2'>
                            Your Completed Books: <span className='text-xl'>{wholeData?.filter(d => d.status.includes('100')).length.toString()}</span>

                        </div>
                    </Link>
                    <Link to='/mapped-books/queue' className='border   bg-white  shadow-md flex-1 flex justify-center p-12 rounded-lg cursor-pointer'>
                        <div className='flex items-center gap-2'>
